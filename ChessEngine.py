...
class GameState:
    def __init__(self):
        # board is a 8x8 2d list, each element of the list has board piece
    ...
    """
    Takes a movee as a parameter and execute it (this will not work for castling, pawn promotion and en-passant).
    """
    def makeMove(self, move):
        ...
        if move.isCastleMove:
            if move.endCol - move.startCol == 2:  # kind side castle move
    ...
    def undoMove(self):
        if len(self.moveLog) != 0:  # make sure there is a move to undo
            ...
            # updates the king's location if moved
            if move.pieceMoved == 'wK':
        ...
        for row in range(len(self.board)):
            for col in range(len(self.board[row])):
                ...
                if (turn == 'w' and self.whiteToMove) or (turn == 'b' and not self.whiteToMove):
                    ...
                    self.moveFunctions[piece](row, col, moves)  # calls the appropriate move functions based on piece type
        return moves
    ...
    def getKnightMoves(self, row, col, moves):
        knightMoves = ((-2, -1), (-2, 1), (-1, -2), (-1, 2), (1, -1), (1, 2), (2, -1), (2, 1))
    ...
    '''
    Generate all valid castle moves for the king at (row, col) and add these to the list of moves
    '''
